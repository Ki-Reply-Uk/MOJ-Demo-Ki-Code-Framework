...
const translations = {
        ...
        prisonerDetailsHeading: "Détails du prisonnier",
        firstNameLabel: "Prénom du prisonnier",
        lastNameLabel: "Nom de famille du prisonnier",
        ...
        bullingdonConvicted: "Bullingdon (condamné uniquement)",
        bullingdonRemand: "Bullingdon (garde à vue uniquement)",
        continueButton: "Continuer",
        enterFirstName: "Veuillez saisir un prénom",
        enterLastName: "Veuillez saisir un nom de famille",
        enterPrisonName: "Veuillez saisir un nom de prison",
        enterValidPrisonerNumber: "Veuillez saisir un numéro de détenu correctement formaté",
        enterPrisonerNumber: "Veuillez saisir un numéro de détenu",
        dobLabel: "Date de naissance du prisonnier",
        enterValidDob: "Veuillez saisir une date de naissance valide (aaaa-mm-jj)"
    };
